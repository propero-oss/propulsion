...
import {RangeFilter, RangeOperator} from "@/repository/filter/range-filter";
...
export type FilterOperator = LogicalOperator | SetOperator | TextOperator | RangeOperator | FuzzyOperator;
export type Filter<T = any, F extends keyof T = any>
    = SetFilter<T, F> | LogicalFilter | TextFilter<T, F> | RangeFilter<T, F> | FuzzyFilter<T, F>;