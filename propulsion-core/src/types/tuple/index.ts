...
export type Tuple<TUPLE extends [...any[]]> =
  ((...r: TUPLE) => void) extends (...a: infer R) => any
    ? R : never;
 ...
 */
export type TuplePush<T extends any[], V, L = TuplePushHelperType[T["length"]], P = { [K in keyof L]: K extends keyof T ? T[K] : V }>
 ...
 * Only works for first 100 elements
 */
export type TuplePop<T extends any[], L = TuplePopHelperType[T["length"]], P = { [K in keyof L]: K extends keyof T ? T[K] : never }>
  = P extends any[] ? P : never;
...
export type TupleUnshift<TUPLE extends [...any[]], ELEMENT> =
  ((e: ELEMENT, ...r: TUPLE) => void) extends (...a: infer R) => any
    ? R : never;
...
export type TupleShift<TUPLE extends [...any[]]> =
  ((...r: TUPLE) => void) extends (e: any, ...a: infer R) => any
    ? R : never;
